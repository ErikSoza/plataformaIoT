...
const rs: Record<string, React.CSSProperties> = {
  ...
  headerSub: { fontSize: '0.875rem', color: '#546e7a' },
  ...
  statusText: { fontSize: '0.875rem', fontWeight: 600, color: '#546e7a' },
  updateText: { fontSize: '0.875rem', color: '#546e7a', marginLeft: '6px' },
  ...
  meteoLabel: { fontSize: '0.875rem', color: '#546e7a', textTransform: 'uppercase', letterSpacing: '0.04em' },
  ...
  gasName: { fontSize: '0.875rem', fontWeight: 600, color: '#546e7a', textTransform: 'uppercase', letterSpacing: '0.04em' },
  gasVal: { fontSize: '1.3rem', fontWeight: 700, lineHeight: 1.1 },
  gasUnit: { fontSize: '0.875rem', color: '#546e7a' },
  gasBadge: { marginTop: '3px', padding: '2px 7px', borderRadius: '10px', fontSize: '0.875rem', fontWeight: 600, color: '#fff' },
};
